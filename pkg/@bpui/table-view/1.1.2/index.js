/*!
 * bpui table-view v1.1.2
 * Copyright (c) 2021 Copyright bpoint.lee@live.com All Rights Reserved.
 * Released under the MIT License.
 */

(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('@bpui/libs'), require('febs-browser'), require('@bpui/popover')) :
  typeof define === 'function' && define.amd ? define(['@bpui/libs', 'febs-browser', '@bpui/popover'], factory) :
  (global = global || self, global.bpTableView = factory(global.bpLibs, global.febs, global.bpPopover));
}(this, (function (bpLibs, febs, bpPopover) { 'use strict';

  bpLibs = bpLibs && Object.prototype.hasOwnProperty.call(bpLibs, 'default') ? bpLibs['default'] : bpLibs;
  bpPopover = bpPopover && Object.prototype.hasOwnProperty.call(bpPopover, 'default') ? bpPopover['default'] : bpPopover;
  ...
  */
  ...
  var __vue_render__ = function __vue_render__() {
    ...
    return _c("div", {
      staticClass: "bp-tableView"
    }, [_c("div", {
      staticClass: "bp-tableView__title"
    }, [_vm._v(_vm._s(_vm.tableTitle) + " ")]), _vm._v(" "), _c("div", {
      staticClass: "bp-tableView__cells",
  ...
  function mobile_onTouchstart_tablecell(event) {
    ...
    if (touch) {
      ...
      if (target.getAttribute("data-mark") === "swiped") {
        $(target).removeClass("bp-tableView__animation").removeClass("bp-tableView__animation-fast");
  ...
  function mobile_onTouchmove_tablecell(event) {
    ...
    if (touch) {
      ...
      if (target.getAttribute("data-mark") === "swiped") {
        ...
        offset /= 2;
        offset -= target.__tableView_start_transform / 2; // else if (offset > target.__tableView_swipedw) offset = target.__tableView_swipedw;

        target.style["-webkit-transform"] = "translate3d(".concat(-offset, "px, 0px, 0px)");
        target.style["-moz-transform"] = "translate3d(".concat(-offset, "px, 0px, 0px)");
        target.style["-ms-transform"] = "translateX(".concat(-offset, "px)");
        target.style["transform"] = "translate3d(".concat(-offset, "px, 0px, 0px)");
  ...
  function mobile_onTouchend_tablecell(event) {
    ...
    if (touch) {
      ...
      if (target.getAttribute("data-mark") === "swiped") {
        ...
        if (swipe) {
          target.style["-webkit-transform"] = "translate3d(-".concat(target.__tableView_swipedw, "px, 0px, 0px)");
          target.style["-moz-transform"] = "translate3d(-".concat(target.__tableView_swipedw, "px, 0px, 0px)");
          target.style["-ms-transform"] = "translateX(-".concat(target.__tableView_swipedw, "px)");
          target.style["transform"] = "translate3d(-".concat(target.__tableView_swipedw, "px, 0px, 0px)");
          target.__tableView_swipered = true; // 还原.

          var _restoreEvent = function restoreEvent(event2) {
  ...
  var script$1 = {
    ...
    computed: {
      nextArrowReal: function nextArrowReal() {
    ...
    mounted: function mounted() {
      ...
      var domTouch = this.$refs.domTouch || this.$refs.editorCellMain;
      this.$bpEventMgr.addEventListener(domTouch, 'touchstart', function (ev) {
        _newArrowCheck(this, _this);

        var target = ev.currentTarget || ev.target;
        $(target).attr('data-touch', 'touch');
      }.bind(this), true);
      this.$bpEventMgr.addEventListener(domTouch, 'touchend', function (ev) {
        _newArrowCheck(this, _this);

        var target = ev.currentTarget || ev.target;
        $(target).attr('data-touch', 'end');
      }.bind(this), true);
      this.$bpEventMgr.addEventListener(domTouch, 'touchcancel', function (ev) {
        _newArrowCheck(this, _this);

        var target = ev.currentTarget || ev.target;
        $(target).attr('data-touch', 'end');
      }.bind(this), true); // click radiobtn & checkbox.

      elem = $(domTouch);
      var iconEl = elem.children().children('.bp-checkbox');
    ...
    methods: {
      _isTrue: function _isTrue(v) {
        return v ? v === 'true' || v === true : false;
      },
      _initIOS: function _initIOS() {
        var _this2 = this;

        if (this.$refs.editor) {
          var elem = $(this.$el);
          var editor = $(this.$refs.editor);
          var editors = editor.children('.bp-tableView__cell__editor')[0];
          $(editors).css("padding-left", "40px");
          var ww = editors.clientWidth - 40;
          $(this.$refs.editorCell).attr('data-swipedw', ww); // 设置背景色.
          ...
          var el = elem.children('.bp-tableView__cell_head')[0];
          ...
          $(el).on('fakeClick', function (event) {
            _newArrowCheck(this, _this2);

            return this.onClickCell(event);
          }.bind(this));
      ...
      _initAndroid: function _initAndroid() {},
      ...
      */
      showEditor: function showEditor() {
        ...
        if (this.$slots.editor) {
          if (this.platform == 'ios') {
            var w = Number($(this.$refs.editorCell).attr('data-swipedw'));
            w = Number.isNaN(w) ? 64 : Math.floor(w);
            var target = $(this.$el).children('.bp-tableView__cell_head');
            target.addClass('bp-tableView__animation');
            target.css('-webkit-transform', "translate3d(-".concat(w, "px, 0px, 0px)"));
            target.css('-moz-transform', "translate3d(-".concat(w, "px, 0px, 0px)"));
            target.css('-ms-transform', "translateX(-".concat(w, "px)"));
            target.css('transform', "translate3d(-".concat(w, "px, 0px, 0px)"));
            target[0].__tableView_swipered = true; // 还原.

            febs.utils.sleep(50).then(function () {
              var _this4 = this;
      ...
      */
      animateDelete: function animateDelete() {
        ...
        this.hideEditor();
        var el = $(this.$el);
        el.css('height', el[0].clientHeight + 'px').removeClass('bp-tableView__animation').addClass('bp-tableView__animation-fast');
      ...
      * @desc: 点击事件.
      */
      onClickCell: function onClickCell(event) {
  ...
  var __vue_render__$1 = function __vue_render__() {
    ...
    return !!_vm.$slots.editor && !_vm._isTrue(_vm.disabled) ? _c("div", {
      ref: "editorCellMain",
      "class": {
      ...
      ref: "editor",
      staticClass: "bp-tableView__cell_foot"
    }, [_vm._t("editor")], 2) : _vm._e(), _vm._v(" "), _vm.platform == "ios" ? _c("div", {
      ref: "editorCell",
      staticClass: "bp-tableView__cell_head",
      staticStyle: {
      ...
      ref: "domTouch",
      staticClass: "bp-tableView__cell"
    }, [_vm._t("default")], 2)]) : _vm._e(), _vm._v(" "), _vm.platform != "ios" ? _vm._t("default") : _vm._e(), _vm._v(" "), _vm.platform != "ios" ? _c("bp-popover", {
      staticClass: "bp-popover__row bp-tableView_popover__main",
      attrs: {
        visible: _vm.popoverVisible,
        bind: _vm.$refs.editorCellMain,
        trigger: "long-press"
      },
      on: {
    ...
    }, [_vm._t("editor")], 2) : _vm._e()], 2) : _vm._isTrue(_vm.disabled) ? _c("div", {
      ref: "domTouch",
      "class": {
        "bp-tableView__cell": true,
      ...
      staticClass: "bp-tableView__cell_next"
    }, [_vm.nextArrowReal ? _c("bp-icon", {
      attrs: {
        name: "bp-tableView_next"
      }
    }) : _vm._e()], 1)], 2) : _c("div", {
      ref: "domTouch",
      "class": {
  ...
  var __vue_render__$2 = function __vue_render__() {
    ...
    return _c("div", {
      staticClass: "bp-tableView__cell__center bp-ellipsis"
    }, [_vm._t("default")], 2);
  };
  ...
  var __vue_render__$3 = function __vue_render__() {
    ...
    return _c("div", {
      staticClass: "bp-tableView__cell__left"
    }, [_vm._t("default")], 2);
  };
  ...
  var __vue_render__$4 = function __vue_render__() {
    ...
    return _c("div", {
      staticClass: "bp-tableView__cell__right bp-ellipsis"
  ...
  var __vue_render__$5 = function __vue_render__() {
    ...
    return _c("div", {
      staticClass: "bp-tableView__cell__editor"
    }, [_vm._t("default")], 2);
  };
  ...
  var index = {
    init: init,
    bpTableView: __vue_component__,
    bpTableCell: __vue_component__$1,
    bpTableCellCenter: __vue_component__$2,
    bpTableCellLeft: __vue_component__$3,
    bpTableCellRight: __vue_component__$4,
    bpTableCellEditor: __vue_component__$5
  };
